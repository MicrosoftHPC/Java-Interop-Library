// ------------------------------------------------------------------------------
// <copyright file="ExitEventListener.java" company="Microsoft">
// Copyright (c) Microsoft Corporation. All rights reserved.
// </copyright>
// <summary>
// Common interface for the Event listener
// </summary>
// ------------------------------------------------------------------------------
/*
 ...
 * @author t-junchw
 * @date May 10, 2011
 * @description Common interface for the Event listener
 */
public interface ExitEventListener extends EventListener
{
    /**
     * @description onExiting interface
     * @param sender
     * @param soaEventArg
     */
