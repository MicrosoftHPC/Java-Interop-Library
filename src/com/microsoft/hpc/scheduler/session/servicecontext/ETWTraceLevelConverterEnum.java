// ------------------------------------------------------------------------------
// <copyright file="ETWTraceLevelConverterEnum.java" company="Microsoft">
// Copyright (c) Microsoft Corporation. All rights reserved.
// </copyright>
// <summary>
// ETW trace level converter
// </summary>
// ------------------------------------------------------------------------------
/*
 ...
 * @author t-junchw
 * @date May 16, 2011
 * @description Convert the java trace level to ETW trace level
 */
public enum ETWTraceLevelConverterEnum {
    ...
    ETWTraceLevelConverterEnum(String value) {
        this.value = value;
    } 
