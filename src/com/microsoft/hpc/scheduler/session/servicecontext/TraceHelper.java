// ------------------------------------------------------------------------------
// <copyright file="TraceHelper.java" company="Microsoft">
// Copyright (c) Microsoft Corporation. All rights reserved.
// </copyright>
// <summary>
// static helper class for trace
// </summary>
// ------------------------------------------------------------------------------
/*
 ...
 * @author t-junchw
 * @date May 10, 2011
 * @description static helper class for trace
 */
public final class TraceHelper
{
    ...
    {
        System.err.printf("%s, [HpcServiceHost]: %s \r\n", getDateTime(),
                message);
    }

    /**
     * @description print trace stack error
     * @param e
     */
    public static void traceStackError(Exception e)
    {
        e.printStackTrace();
    }
