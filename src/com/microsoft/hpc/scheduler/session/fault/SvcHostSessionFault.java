// <copyright file="SessionFault.java" company="Microsoft">
 ...
 * @author t-junchw
 * @date May 10, 2011
 * @description used to be marshaled to XML format
 */
@XmlRootElement(name="SessionFault",namespace="http://hpc.microsoft.com/session/")
...
public class SvcHostSessionFault {

    @XmlTransient
    public static final String Action = "http://hpc.microsoft.com/session/SessionFault";
   
    @XmlElement(name = "Code", namespace = "http://hpc.microsoft.com/session/")
    protected Integer code;
    @XmlElementRef(name = "Context", namespace = "http://hpc.microsoft.com/session/", type = JAXBElement.class)
    protected JAXBElement<ArrayOfanyType> context;
    @XmlElementRef(name = "Reason", namespace = "http://hpc.microsoft.com/session/", type = JAXBElement.class)
