//------------------------------------------------------------------------------
// <copyright file="SessionException.java" company="Microsoft">
...
/**
 * The class <code>SessionException</code> is a form of <code>Exception</code>
 * that indicates there was an issue with the Microsoft HPC Session
 */
public class SessionException extends Exception
{
    ...
    SessionException(WebServiceException we) {
        super(we.getLocalizedMessage());
    }

    SessionException(Exception e) {
        super(SR.v("ExceptionInCreatingSession"), e);
    }
    ...
    SessionException(int errorCode, String msg) {
        super(msg);
     ...
     *            the exception that caused the outer exceptions
     */
