//------------------------------------------------------------------------------
// <copyright file="SessionBasedDataLifeCycleContext.java" company="Microsoft">
//      Copyright (c) Microsoft Corporation.  All rights reserved.
// </copyright>
// <summary>
//      Session based data life cycle context
// </summary>
//------------------------------------------------------------------------------
/*
...
class SessionBasedDataLifeCycleContext extends DataLifeCycleContextBase
{
    int sessionId;

    public SessionBasedDataLifeCycleContext(int sessionid) {
        if (sessionid < 0 && sessionid != -1)
            throw new IllegalArgumentException(SR.v("SessionIdInvalid",
                    sessionid));
    ...
    public String[] getNameSpace() {
        return new String[] { Integer.toString(this.sessionId) };
    }
}
