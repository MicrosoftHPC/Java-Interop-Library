...
@XmlRootElement(name = "GenericOperation")
public class GenericOperation {

    @XmlElementRef(name = "args", namespace = "http://hpc.microsoft.com/GenericService", type = JAXBElement.class, required = false)
    ...
    public void setArgs(JAXBElement<String> value) {
        this.args = ((JAXBElement<String> ) value);
    }
