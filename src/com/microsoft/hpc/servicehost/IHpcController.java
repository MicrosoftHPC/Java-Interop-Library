// ------------------------------------------------------------------------------
// <copyright file="IHpcController.java" company="Microsoft">
// Copyright (c) Microsoft Corporation. All rights reserved.
// </copyright>
// <summary>
// The Interface of Controller Service
// </summary>
// ------------------------------------------------------------------------------
/*
 ...
 * @author t-junchw
 * @date May 9, 2011
 * @description interface of controller service
 */
@WebService(targetNamespace="http://hpc.microsoft.com/hpcservicehost/",name = "IHpcServiceHost")
public interface IHpcController
{

    /**
     * @description exit interface of controller service
     */
    @Oneway
    @WebMethod(action = "http://hpc.microsoft.com/hpcservicehost/exit")
    public void Exit();
}
