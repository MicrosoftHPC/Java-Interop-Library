// ------------------------------------------------------------------------------
// <copyright file="StringParameter.java" company="Microsoft">
 ...
 * @author t-junchw
 * @date May 10, 2011
 * @description parameter for the String type in debug mode
 */
public class StringParameter extends Parameter
{
    /**
     * @field parameter value in String type
     */
    ...
    /**
     * @description constructor of StringParameter class
     * @param name
     * @param description
     */
     ...
     * @description parse String type value
     */
    @Override
