...
@XmlRootElement(name = "GetServiceVersions")
public class GetServiceVersions {

    @XmlElementRef(name = "serviceName", namespace = "http://hpc.microsoft.com/sessionlauncher/", type = JAXBElement.class, required = false)
