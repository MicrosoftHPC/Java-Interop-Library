...
public class Main {
    ...
    /**
     * @param args java -jar Microsoft-HpcHost-3.0.jar /JobId jid /TaskSystemId
     * tid /CoreId cid /RegistrationFileName filename /RegistrationPath path
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            TraceHelper.traceInformation("exit Main() normally.");
    ...
    private static String GetServiceInfo(String serviceConfigFileName) {
        ...
        try {
            ...
            TraceHelper.traceInformation(registryPath);
            ServiceRegistrationRepo serviceRegistration = new ServiceRegistrationRepo(
                    Environment.getEnvironmentVariable(Constant.HeadnodeEnvVar),
                    registryPath);
