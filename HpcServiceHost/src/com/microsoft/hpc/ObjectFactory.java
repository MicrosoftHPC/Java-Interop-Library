...
public class ObjectFactory {
    ...
    private final static QName _SessionStartInfoContractAutoDisposeBrokerClient_QNAME = new QName("http://hpc.microsoft.com/", "AutoDisposeBrokerClient");
    private final static QName _SessionStartInfoContractUseAzureQueue_QNAME = new QName("http://hpc.microsoft.com/", "UseAzureQueue");
    private final static QName _SessionStartInfoContractDependFiles_QNAME = new QName("http://hpc.microsoft.com/", "DependFiles");
    private final static QName _SessionStartInfoContractClientVersion_QNAME = new QName("http://hpc.microsoft.com/", "ClientVersion");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hpc.microsoft.com/", name = "AutoDisposeBrokerClient", scope = SessionStartInfoContract.class)
    public JAXBElement<Boolean> createSessionStartInfoContractAutoDisposeBrokerClient(Boolean value) {
        return new JAXBElement<Boolean>(_SessionStartInfoContractAutoDisposeBrokerClient_QNAME, Boolean.class, SessionStartInfoContract.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hpc.microsoft.com/", name = "UseAzureQueue", scope = SessionStartInfoContract.class)
    public JAXBElement<Boolean> createSessionStartInfoContractUseAzureQueue(Boolean value) {
        return new JAXBElement<Boolean>(_SessionStartInfoContractUseAzureQueue_QNAME, Boolean.class, SessionStartInfoContract.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hpc.microsoft.com/", name = "DependFiles", scope = SessionStartInfoContract.class)
    public JAXBElement<String> createSessionStartInfoContractDependFiles(String value) {
        return new JAXBElement<String>(_SessionStartInfoContractDependFiles_QNAME, String.class, SessionStartInfoContract.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hpc.microsoft.com/", name = "ClientVersion", scope = SessionStartInfoContract.class)
    public JAXBElement<Version> createSessionStartInfoContractClientVersion(Version value) {
        return new JAXBElement<Version>(_SessionStartInfoContractClientVersion_QNAME, Version.class, SessionStartInfoContract.class, value);
    }
