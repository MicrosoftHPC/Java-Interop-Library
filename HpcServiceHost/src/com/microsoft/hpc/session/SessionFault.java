...
/**
 * <p>Java class for SessionFault complex type.
 * 
...
@XmlType(name = "SessionFault", propOrder = {
    "code",
    "context",
    "reason"
})
public class SessionFault {
    ...
    @XmlElementRef(name = "Context", namespace = "http://hpc.microsoft.com/session/", type = JAXBElement.class, required = false)
