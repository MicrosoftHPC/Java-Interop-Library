// ------------------------------------------------------------------------------
// <copyright file="Sender.java" company="Microsoft">
// Copyright (c) Microsoft Corporation. All rights reserved.
// </copyright>
// <summary>
// Indicate the sender for the event
// </summary>
// ------------------------------------------------------------------------------
/*
 ...
 * @author t-junchw
 * @date May 10, 2011
 * @description Event Arg indicates the sender of the event
 */
public class Sender extends EventObject
{

    /**
     * @field for java class serialization
     */
    private static final long serialVersionUID = -2171241146912518853L;

    public Sender(Object source)
    {
        super(source);
    }
