// ------------------------------------------------------------------------------
// <copyright file="SrtingResource.java" company="Microsoft">
// Copyright (c) Microsoft Corporation. All rights reserved.
// </copyright>
// <summary>
// Retrieve the String using bundle
// </summary>
// ------------------------------------------------------------------------------
/*
...
{
    static ResourceBundle bundle = ResourceBundle.getBundle("StringTableBundle");
 
    /**
     * @description get String resource from bundle file
     * @param name
