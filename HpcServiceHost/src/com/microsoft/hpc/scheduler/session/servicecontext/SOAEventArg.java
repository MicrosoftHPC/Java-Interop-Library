// ------------------------------------------------------------------------------
// <copyright file="SOAEventArg.java" company="Microsoft">
// Copyright (c) Microsoft Corporation. All rights reserved.
// </copyright>
// <summary>
// It is exposed through ServiceContext.onExiting method.
// </summary>
// ------------------------------------------------------------------------------
/*
 ...
 * @author t-junchw
 * @date May 10, 2011
 * @description argument for the onExiting event
 */
public class SOAEventArg extends EventArg
{
    /**
     * @field serialVersionUID used for class serialization
     */
    private static final long serialVersionUID = 3672667212733429803L;

    public SOAEventArg(int faultCode)
    {
        super(new Object());
    ...
    /**
     * @field the fault code falls in the range of SOAFaultCode
     */
