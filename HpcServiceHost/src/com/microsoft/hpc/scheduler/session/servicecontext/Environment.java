// ------------------------------------------------------------------------------
// <copyright file="Environment.java" company="Microsoft">
...
public final class Environment {
    ...
    /**
     * @description get environment variable by index
     * @param index
     * @return specific environment
     */
    public static String getEnvironmentVariable(String index) {
        if (isDebug) {
            // Retrieve the Environment Variable from the System Property in
            // Debug mode
            return System.getProperty(index);
        } else {
            // Retrieve the Environment Variable from the System Environment
    ...
    /**
     * @description set property for debug mode
     * @param procNumEnvVar
     * @param string
     */
    public static void setEnvironmentVariable(String procNumEnvVar,
            String string) {
        // set property for debug
        System.setProperty(procNumEnvVar, string);
    }
