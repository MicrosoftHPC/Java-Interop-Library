...
public class ServiceRegistration {
    ...
    private final String serviceTypeAttributeName = "type";
    private final String includeFaultedExceptionAttributeName = "includeExceptionDetailInFaults";
    ...
    /**
     * @description parse the XML node list to get the service registration
     * settings
     * @param nodelist
     */
            ...
            for (rootNode = rootNode.getFirstChild(); rootNode != null; rootNode = rootNode
                ...
                if (rootNode.getNodeName() == serviceNodeName) {
                    ...
                    try {
                        ...
                        TraceHelper.traceInformation("serviceAssemblyFullPath is " + serviceAssemblyFullPath);
                    ...
                    try {
                        ...
                        TraceHelper.traceInformation("serviceContractName is " + serviceContractName);
                    } catch (Exception e) {
                        TraceHelper.traceError(e.toString());
                    }
                    ...
                    try {
                        ...
                        TraceHelper.traceInformation("serviceTypeName is " + serviceTypeName);
                    } catch (Exception e) {
                        TraceHelper.traceError(e.toString());
                    }
                    ...
                    try {
                        includeFaultedException = Boolean.parseBoolean(map
                                ...
                                .getNodeValue());
                        TraceHelper.traceInformation("includeFaultedException is " + includeFaultedException);
                    } catch (Exception e) {
                        TraceHelper.traceError(e.toString());
                    }
                    ...
                    try {
                        if (map.getNamedItem(soaDiagTraceLevelAttributeName) != null
                            ...
                            TraceHelper.traceInformation("soaDiagTraceLevel is " + soaDiagTraceLevel);
                        }
                    } catch (Exception e) {
                        TraceHelper.traceError(e.toString());
                    }
    ...
    public void setEnableWSAddressing(Document doc) {
        ...
        TraceHelper.traceInformation("enableWSAddressing is " + enableWSAddressing);
    }
