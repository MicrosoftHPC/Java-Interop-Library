//------------------------------------------------------------------------------
// <copyright file="ResponseListener.java" company="Microsoft">
...
/**
 * The listener interface to
 * 
 * @author junsu
 * @param <E>
 * 
 */
public interface ResponseListener<E> extends EventListener
{
    /**
     * invoke when response is returned
     * 
     * @param response
     *            the response message
     */
    void responseReturned(BrokerResponse<E> response);

    /**
     * invoke when all the response is returned
     */
    void endOfMessage();

    /**
     * Callback when hit any error
     * 
     * @param e
     */
