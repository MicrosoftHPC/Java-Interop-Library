...
public class Constant {
     ...
     * Element name of user data SOAP header
     */
    final public static String MessageIdHeaderName = "HPCServer2008_Broker_MessageIdNS";
     ...
     * Element name of user data SOAP header
     */
    final public static String UserNameHeaderName = "HPCServer2008_Broker_UserNameNS";

    /**
     * Element name of user data SOAP header
     */
    final public static String ClientInstanceIdHeaderName = "HPCServer2008_Broker_ClientInstanceIdNS";
     ...
     */
    final public static int PurgeTimeoutMS = 60 * 1000;
     ...
     * The environment variable for data server location
     */
    final public static String DataServerForLinuxEnv = "HPC_SOADATASERVER_FOR_LINUX";
    ...
    /**
     * @field HPC_SOAM_SERVICE_NAME
     */
    final public static String SoamServiceNameEnvVar = "HPC_SOAM_SERVICE_NAME";

    /**
     * @field HPC_SOAM_SERVICE_ASSEMBLY
     */
    final public static String SoamServiceAssemblyEnvVar = "HPC_SOAM_SERVICE_ASSEMBLY";
     ...
     *
     */
    final public static String SoaDataServerInfoForLinuxEnvVar = "HPC_SOADATASERVER_FOR_LINUX";

    /**
     * @field Env var used to pass soa common data client id information to
     * service hosts
     */
    final public static String CcpCommonDataClientIdEnvVar = "CCP_COMMONDATA_CLIENTID";

    /**
     * @field Message header name of Preemption The service host adds the header
     * to the response message when the process is preempted, and the broker
     * reads it. The value type is integer.
     *
     */
