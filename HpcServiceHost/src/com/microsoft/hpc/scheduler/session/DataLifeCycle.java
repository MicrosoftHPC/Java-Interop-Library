//------------------------------------------------------------------------------
// <copyright file="DataLifeCycle.java" company="Microsoft">
...
{
    DataLifeCycleContextBase context;

    /**
     * Create a DataLifeCycle object that aligns with lifetime of a session.
     * Data associated with this DataLifeCycle object will be automatically
     * removed on session close.
     * 
     * @param sessionId
     */
    public DataLifeCycle(int sessionId) {
        this.context = new SessionBasedDataLifeCycleContext(sessionId);
    }
