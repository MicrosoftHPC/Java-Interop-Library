...
class CxfBrokerControllerClient extends CxfClientBase {
     ...
     *
     * @param username user name if this is a secure session
     * @param password password if this is a secure session
     * @param EPRAddr brokerController epr
     */
    ...
    public void endRequests(int sendCount, String clientId, int batchId, int largerTimeout,
            int timeoutMilliseconds) throws SessionException {
        try {
            this.brokerController.endRequests(sendCount, clientId, batchId,
    ...
    public void flush(int sendCount, String clientId, int batchId, int largerTimeout,
            int timeoutMilliseconds) throws SessionException {

        try {
            this.brokerController.flush(sendCount, clientId, batchId, largerTimeout,
                    timeoutMilliseconds);
