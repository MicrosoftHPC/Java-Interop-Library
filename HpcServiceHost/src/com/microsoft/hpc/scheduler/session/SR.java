//------------------------------------------------------------------------------
// <copyright file="SR.java" company="Microsoft">
...
/**
 * Autogenerated Java class with SR Text
 */
class SR
{
    static ResourceBundle bundle = ResourceBundle
            .getBundle("FaultCodeMessageBundle");
    ...
    public static String v(String name, Object... args) {
        return String.format(v(name), args);
    }
}
