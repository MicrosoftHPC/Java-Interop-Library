...
public class BrokerClient<TContract extends Service> {
     ...
     */
    final public int DEFAULT_TIMEOUT = 60 * 1000;
    ...
    /**
     * if the broker response handler is configured. Only one response handler
     * is allowed
     */
     ...
     *
     * @param session Session or DurableSession
     ...
     * Creates instances of the BrokerClient
     *
     * @param clientid String identity of the client
     * @param session Session or DurableSession
     * @param service Service class to instantiate
     */
     ...
     *
     * @param session Session or DurableSession
     * @param bindingConfigName Binding configuration to use to connect to
     * broker
     * @param service Service class to instantiate
     */
     ...
     * @param clientid String identity of the client
     * @param session Session or DurableSession
     * @param bindingConfigName Binding configuration to use to connect to the
     * broker
     * @param service Service class to instantiate
     */
    public BrokerClient(String clientid, SessionBase session,
     ...
     * @param bindingConfigName Binding configuration to use to connect to the
     * broker
     * @param _clientId String identity of the client
     * @param service Service class to instantiate
     * @throws Exception
     */
    private void init(SessionBase session, String bindingConfigName,
        ...
        TraceHelper.traceInformation("epr = " + epr);
     ...
     *
     * @param <TMessage> Typed message type
     * @param request Typed message to send
     ...
     * @param <TMessage> Typed message type
     * @param request Typed message to send
     * @param userData User data (will be converted to String because of Java
     * limitations)
     * @throws SessionException
     * @throws TimeoutException
     * @see {@link HpcJava#createRequest(Class, Object...)}
     ...
     * @param userData User data (will be converted to String because of Java
     * limitations)
     * @param action Action of typed message if type is ambiguous
     * @throws SessionException
     * @throws TimeoutException
     * @see {@link HpcJava#createRequest(Class, Object...)}
     */
     ...
     * limitations)
     * @param action Action of typed message if type is ambiguous
     * @param messageId messageId of message to send
     * @throws SessionException
     * @throws TimeoutException
     * @see {@link HpcJava#createRequest(Class, Object...)}
     */
     ...
     *
     * @param timeoutMilliseconds timeout before exception
     * @throws TimeoutException
     * @throws SessionException
     ...
     *
     * @param purge if true, the result will be removed in the broker
     * @throws SessionException
     * @throws TimeoutException
     */
     ...
     *
     * @param purge if true, the result will be removed in the broker
     * @param timeoutMilliseconds the timeout for the response if purge
     * @throws TimeoutException
     * @throws SessionException
     */
