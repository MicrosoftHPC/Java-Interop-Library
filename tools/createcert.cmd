...
makecert.exe -r -pe -n "CN=%COMPUTERNAME%" -b 09/01/2011 -e 09/01/2017 -eku 1.3.6.1.5.5.7.3.1 -ss my -sky exchange -sp "Microsoft RSA SChannel Cryptographic Provider" -sy 12 -sr LocalMachine
