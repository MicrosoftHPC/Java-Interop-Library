...
/**
 * <p>Java class for CommonDataError complex type.
 * 
...
@XmlType(name = "CommonDataError", propOrder = {
    "errorCode",
    "reason"
})
public class CommonDataError {
    ...
    @XmlElementRef(name = "Reason", namespace = "http://schemas.datacontract.org/2004/07/AITestLib.Helper", type = JAXBElement.class, required = false)
