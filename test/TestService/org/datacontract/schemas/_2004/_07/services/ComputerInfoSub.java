...
/**
 * <p>Java class for ComputerInfo.Sub complex type.
 * 
...
@XmlType(name = "ComputerInfo.Sub", propOrder = {
    "subE",
    "subF",
    "subI",
    "subS"
})
public class ComputerInfoSub {

    @XmlElement(name = "sub_e")
    protected TestEnum subE;
    @XmlElement(name = "sub_f")
    protected Float subF;
    @XmlElement(name = "sub_i")
